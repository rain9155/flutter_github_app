...
const VALUE_MENTIONED = 'mentioned';
...
const MSG_TOKEN_PENDING = 'authorization_pending';
...
const CODE_CONNECT_TIMEOUT = -2;
const CODE_REQUEST_CANCEL = -3;
const CODE_CONNECT_LOST = -4;
const CODE_REQUEST_ERROR = -5;
const CODE_TOKEN_ERROR = -10;
const CODE_TOKEN_PENDING = -11;
const CODE_TOKEN_SLOW_DOWN = -12;
...
const ROUTE_TYPE_ISSUES_USER = 40;
const ROUTE_TYPE_ISSUES_REPO = 41;
const ROUTE_TYPE_SEARCHES_REPO = 50;
const ROUTE_TYPE_SEARCHES_ISSUE = 51;
const ROUTE_TYPE_SEARCHES_PULL = 52;
const ROUTE_TYPE_SEARCHES_USER = 53;
const ROUTE_TYPE_SEARCHES_ORG = 54;

const PAGE_TYPE_ISSUES_CREATED = 100;
const PAGE_TYPE_ISSUES_ASSIGNED = 101;
const PAGE_TYPE_ISSUES_MENTIONED = 102;
const PAGE_TYPE_ISSUES_OPEN = 103;
const PAGE_TYPE_ISSUES_CLOSED = 104;
const PAGE_TYPE_PROFILE_ORG = 110;
const PAGE_TYPE_PROFILE_USER = 111;
const PAGE_TYPE_PULLS_OPEN = 120;
const PAGE_TYPE_PULLS_CLOSED = 121;
